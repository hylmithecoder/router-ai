...
const ENDPOINTS: ApiEndpoint[] = [
    ...
    defaultBody: JSON.stringify(
      {
        ...
        messages: [
          {
            role: "user",
            content: "Explain hybrid Mamba-Transformer MoE architecture in 2 bullet points.",
          },
        ],
        temperature: 0.7,
        max_tokens: 512,
        ...
        body: JSON.stringify(
          {
            ...
            messages: [{ role: "user", content: "Explain Rust ownership in 2 simple sentences." }],
            temperature: 0.6,
          },
          null,
          2
        ...
        body: JSON.stringify(
          {
            ...
            messages: [{ role: "user", content: "Write a concise summary of distributed computing." }],
            temperature: 0.7,
          },
          null,
          2
        ...
        body: JSON.stringify(
          {
            ...
            messages: [{ role: "user", content: "Provide 3 key optimizations for SQLite databases." }],
            temperature: 0.7,
          },
          null,
          2
        ...
        body: JSON.stringify(
          {
            ...
            messages: [{ role: "user", content: "Solve step-by-step: How many r's are in strawberry?" }],
            temperature: 0.6,
          },
          null,
          2
        ...
        body: JSON.stringify(
          {
            ...
            messages: [{ role: "user", content: "Design a high-throughput async pipeline architecture in Rust." }],
            temperature: 0.6,
          },
          null,
          2
        ...
        body: JSON.stringify(
          {
            ...
            messages: [{ role: "user", content: "Describe the importance of multimodal perception in autonomous systems." }],
            temperature: 0.7,
          },
          null,
          2
  ...
  },
  {
    ...
    defaultBody: JSON.stringify(
      {
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Indonesian_license_plate_B_1234_ABC.jpg/640px-Indonesian_license_plate_B_1234_ABC.jpg",
        instruction: "Ekstrak plat nomor kendaraan dan tipe kendaraan dengan teliti.",
        model: "nvidia/nemotron-3-nano-omni-30b-a3b-reasoning",
      },
      null,
      2
  ...
  },
  {
    ...
    description: "Returns all active upstream models and provider aliases served by the router.",
    auth: "API Key (Bearer)",
  },
  {
    id: "unified-chat",
    ...
    defaultBody: JSON.stringify(
      {
        provider: "auto",
        messages: [{ role: "user", content: "Summarize quantum computing in 1 sentence." }],
      },
      null,
      2
    ),
  ...
  },
  {
    ...
    description: "Aggregated today metrics, per-key usage, provider distribution, and 7-day volume.",
  ...
  },
  {
    ...
    description: "Performs real-time UDP DNS queries directly against 1.1.1.1 / 8.8.8.8 to bypass ISP filters and resolve domain IPs.",
    auth: "Master Key (Bearer)",
  },
];
...
export default function ApiDocsPage() {
  ...
  const [activeLang, setActiveLang] = useState<"curl" | "python" | "typescript" | "rust">("curl");
  ...
  function generateSnippet(lang: "curl" | "python" | "typescript" | "rust"): string {
    ...
    <Shell>
      <div className="flex flex-col gap-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-zinc-100">API Documentation & Swagger Playground</h1>
            <p className="mt-1 text-sm text-zinc-400">
              Interactive OpenAPI reference, live testing console, and code generator for router-api-ai.
            </p>
          </div>
          <button
        ...
        <Card className="bg-zinc-900/40">
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <Badge tone={apiKey ? "green" : "amber"}>{apiKey ? "Configured" : "Not Set"}</Badge>
            </div>
            ...
            <p className="text-xs text-zinc-500">
              Used automatically in the Authorization Bearer header for live testing.
            </p>
          </div>
        </Card>
              ...
              {ENDPOINTS.map((ep) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-xs text-zinc-400 line-clamp-1">{ep.summary}</p>
                  </button>
                );
              })}
            </div>
            ...
            <Card>
              ...
              <div className="flex flex-wrap items-start justify-between gap-3 border-b border-zinc-800 pb-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <p className="text-sm text-zinc-300">{selectedEndpoint.description}</p>
                </div>
                <Badge tone={selectedEndpoint.auth === "None" ? "zinc" : "green"}>
              ...
              <div className="mt-4 flex flex-wrap items-center justify-between gap-3 pt-2">
                ...
                {responseDuration !== null && (
                  <span className="font-mono text-xs text-zinc-400">
                    Latency: <strong className="text-zinc-200">{responseDuration} ms</strong>
                  </span>
                )}
              </div>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between border-b border-zinc-800 pb-2">
                  <div className="flex gap-2">
                    {(["curl", "python", "typescript", "rust"] as const).map((lang) => (
                      <button
                        key={lang}
                  ...
                  <button
                    onClick={() => copyCode(generateSnippet(activeLang), activeLang)}
