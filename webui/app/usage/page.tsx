...
import { api, formatDuration, formatTime, formatTokens, getMasterKey, type UsageLogRow } from "@/lib/api";
            ...
            <tbody className="divide-y divide-zinc-800/60">
              {rows.map((r) => (
                <tr key={r.id} className="hover:bg-zinc-800/40">
                  ...
                  <td className="px-4 py-2.5 font-mono text-xs text-zinc-400">{r.model}</td>
                  <td className="px-4 py-2.5 font-mono text-xs text-zinc-400">{r.provider}</td>
