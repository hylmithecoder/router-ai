...
export default function ProvidersPage() {
  ...
  async function create(e: React.FormEvent) {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "failed to add Groq key");
    } finally {
      setBusy(false);
    }
  }
      ...
      <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">
            Add as many Groq keys as you need; the router fails over between them.
          </p>
        </div>
          ...
          <form onSubmit={create} className="flex flex-col gap-3">
            <div>
              ...
              <input
                ...
                placeholder="Groq production 03"
            ...
            <div>
              <label className="mb-1 block text-xs text-zinc-500">Groq API key</label>
              <input
                type="password"
                value={apiKey}
